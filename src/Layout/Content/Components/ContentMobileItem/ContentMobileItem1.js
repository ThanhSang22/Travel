    ...
    return (
        <div className='content-monile-item'>
            <div class="item__photo">
                <img src={dataContentMobile.image} alt="photo-europe" class="item__photo-img"/>
                <div class="item__fill1">
                    <div class="item__icon">
                        <img src={dataContentMobile.icon} alt="europe-icon" class="item__icon-img"/>
                    </div>
                ...
                <div class="item__fill2">
                    ...
                    <ul class="item-list">
                        <li class="item-item">
                            <a href="" class="item-link">{dataContentMobile.destination}</a>
                        </li>
                        {/* <li class="item-item">
